    ...
    return (
        <AnimatePresence>
            {visibleNotification && (
                ...
                >
                    <div className="bg-white dark:bg-zinc-900 border border-gray-100 dark:border-white/10 shadow-2xl rounded-xl p-3.5 flex items-center gap-3">
                        {/* Status Icon with a subtle ping pulse animation */}
                        <div className="relative w-9 h-9 bg-emerald-50 dark:bg-emerald-900/30 rounded-full flex items-center justify-center shrink-0">
